          ...
          <div className="row g-4">
            {[
              ...
              },
              {
                ...
                desc: "Точные и полные расчёты вашего проекта.",
              },
              {
                src: "/images/tool3.jpg",
                title: "AI‑инструменты",
                desc: "Быстрый результат с помощью натренированного искуственного интеллекта.",
              },
            ].map((tool, i) => (
              <div
                key={i}
          ...
          <div className="row align-items-center g-4">
            ...
            <div className="col-md-6">
              ...
              <p>
                ...
                инспеции и возьмет там ставки сборов на сегодня, не на дату
                обучения какой-то нейросети. Хотите понять кто ваши конкуренты в
                городе? Или получить анализ рынка по стране? Наши AI-инструменты
                сделают это быстро и точно.
              </p>
            </div>
          </div>
        </section>
